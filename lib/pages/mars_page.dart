...
class _MarsPageState extends State<MarsPage> with SingleTickerProviderStateMixin{
                            ...
                            Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 10,),
                                    Text("Mars is the fourth planet from the Sun and the"
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        // SizedBox(width: 10,),
                        Text("54.6m km",style: mysstyle,),
                        Image.asset("image/ic_gravity.png",height: 20,),
                        // SizedBox(width: 10,),
                        Text("3.711 m/s²",style: mysstyle,)
                      ],
                    )
                  ],
                ),
