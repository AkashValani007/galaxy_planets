...
class NaptunePage extends StatefulWidget {
  const NaptunePage({Key? key}) : super(key: key);

  @override
  State<NaptunePage> createState() => _NaptunePageState();
}

class _NaptunePageState extends State<NaptunePage> with SingleTickerProviderStateMixin{
                            ...
                            Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 10,),
                                    Text("naptune is the fourth planet from the Sun and the"
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        // SizedBox(width: 10,),
                        Text("2.70b km",style: mysstyle,),
                        Image.asset("image/ic_gravity.png",height: 20,),
                        // SizedBox(width: 10,),
                        Text("11.5 m/s²",style: mysstyle,)
                      ],
                    )
                  ],
                ),
